...
fournisseur INT AUTO_INCREMENT NOT NULL,
...
produit INT AUTO_INCREMENT NOT NULL,
...
CREATE TABLE ACHATS(
achat INT AUTO_INCREMENT NOT NULL,
...
achat INT,
fournisseur INT,
PRIMARY KEY (Matricule, achat, fournisseur),
